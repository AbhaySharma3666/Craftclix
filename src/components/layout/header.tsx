...
import LightLogo from '/public/images/logos 2/black.png';
import DarkLogo from '/public/images/logos 2/white.png';
    ...
    <Typography variant="h3" className="font-bold">
      {theme === 'dark' ? (
        <Image
          ...
          className="h-8" // Optional: Tailwind class for extra styling
        />
      ) : (
        <Image
          src={LightLogo}
