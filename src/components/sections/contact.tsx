...
let email = 'khushalgupta7770@gmail.com';
let phone = '+91 7000477800';
    ...
    <Container id="contact">
      <div className="flex flex-col items-center gap-4">
        ...
        <Typography variant="subtitle" className="max-w-xl text-center">
          What&apos;s next? Feel free to reach out to us if you&apos;re looking 
          for a team of developers, have any queries, or simply want to 
